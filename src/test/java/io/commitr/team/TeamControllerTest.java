...
public class TeamControllerTest {
    ...
    public void getTeamsWithValidIdentity() throws Exception {
        this.mvc.perform(get("/team?identity=" + DTOUtils.VALID_UUID_STRING)
                .accept(MediaType.APPLICATION_JSON_UTF8))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8))
    ...
    @Test
    public void getTeamsWithInvalidIdentity() throws Exception {
        this.mvc.perform(get("/team?identity=" + DTOUtils.NON_VALID_UUID_STRING)
                .accept(MediaType.APPLICATION_JSON_UTF8))
                .andExpect(status().isNotFound());}

    @Test
    public void getTeamsWithInvalidUUID() throws Exception {
        this.mvc.perform(get("/team?identity=invalid-uuid-format")
                .accept(MediaType.APPLICATION_JSON_UTF8))
                .andExpect(status().is4xxClientError());
